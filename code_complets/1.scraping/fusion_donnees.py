...
# Vérifier et harmoniser les colonnes pour Facebook
...
# Vérifier et harmoniser les colonnes pour les tweets
print("Colonnes du fichier Tweets avant harmonisation:", tweets_df.columns)
if len(tweets_df.columns) == 3:
    tweets_df.columns = ['Auteur', 'Texte', 'Date']  # Corriger l'ordre des colonnes ici
else:
